...
def chatbot_send(uid: str, message: str, image: str | None) -> str | ErrorObject:
    ...
    if uid not in chatbots:
        return ErrorObject(500, "Internal Server Error") #Corresponding chatbot instances to uid not found
    else:
...
def chatbot_log(uid: str) -> dict | ErrorObject:
    ...
    if memory_usage > 90:
        return ErrorObject(500, "Internal Server Error") #Not enough memory
